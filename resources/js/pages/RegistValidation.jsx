...
export const registrationData = [
  {
    ...
    file_registration: "https://example.com/files/registration1.pdf",
    submittedAt: "2025-10-01 10:15",
  ...
  },
  {
    ...
    file_registration: "https://example.com/files/registration2.pdf",
    submittedAt: "2025-10-01 11:20",
  ...
  },
  {
    ...
    file_registration: "https://example.com/files/registration4.pdf",
    submittedAt: "2025-10-01 12:30",
    validationStatus: "Pending",
  },
  {
    id: 5,
            ...
            <Breadcrumb>
              <BreadcrumbList>
                <BreadcrumbItem className="hidden md:block">
                  <BreadcrumbLink href="/register-validation">
        ...
        <div className="flex flex-1 flex-col">
          ...
          <div className="flex flex-col gap-4 lg:py-2 lg:px-4 p-2 md:gap-2 md:py-2 border border-foreground/10 rounded-lg mx-4">
            ...
            <div className="px-4 lg:px-2">
              <DataTable data={registrationData} columns={getRegistrationColumns()} />
            </div>
          </div>
        </div>
      </SidebarInset >
