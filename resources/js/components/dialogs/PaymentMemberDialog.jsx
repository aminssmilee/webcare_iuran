...
// ===========================================================
// 💰 Komponen Utama PaymentMemberDialog
// ===========================================================
export function PaymentMemberDialog({ open, onOpenChange, children, paidMonths = [] }) {
  ...
  // =======================================================
  // 🔄 Update status otomatis berdasarkan pilihan bulan
  // =======================================================
  React.useEffect(() => {
                ...
                <Command>
                  <CommandGroup>
                    {MONTHS.map((month) => {
                      ...
                      const isAlreadyPaid = paidMonths.includes(idx)
